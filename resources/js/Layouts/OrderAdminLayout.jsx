...
export default function OrderAdminLayout({ auth, header, children }) {
            ...
            <nav className="bg-white border-b border-gray-100">
                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink href={route('handler-dashboard.index')} active={route().current('handler-dashboard.index')}>
                                    Manage Orders
                                </NavLink>
                ...
                <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                    <div className="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink href={route('handler-dashboard.index')} active={route().current('handler-dashboard.index')}>
                            Manage Orders
                        </ResponsiveNavLink>
                    </div>
